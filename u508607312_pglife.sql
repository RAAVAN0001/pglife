...
(4, 1, 'PG for Girls Borivali West', 'Plot no.258/D4, Gorai no.2, Borivali West, Mumbai, Maharashtra 400092', 'Furnished studio apartment - share it with close friends! Located in posh area of Bijwasan in Delhi, this house is available for both boys and girls. Go for a private room or opt for a shared one and make it your own abode. Go out with your new friends - catch a movie at the nearest cinema hall or just chill in a cafe which is not even 2 kms away. Unwind with your flatmates after a long day at work/college. With a common living area and a shared kitchen, make your own FRIENDS moments. After all, there\'s always a Joey with unlimited supply of food. Remember, all it needs is one crazy story to convert a roomie into a BFF. What\'s nearby/Your New Neighborhood 4.0 Kms from Dwarka Sector- 21 Metro Station.', 'female', 8000, 4.2, 4.1, 4.5),
...
(6, 3, 'Green Haven PG', '1234 Green Street, Bangalore, Karnataka 560001', 'A cozy PG with a green touch. Enjoy the serene surroundings and a friendly community. Ideal for both male and female occupants.', 'unisex', 7000, 4.1, 4.0, 4.5),
(7, 3, 'Silicon Oasis Residency', 'Tech Park Road, Electronic City, Bangalore, Karnataka 560100', 'Perfect for tech enthusiasts! Modern amenities and a vibrant atmosphere. Male occupants preferred.', 'male', 8500, 4.3, 4.2, 4.6),
(8, 4, 'Charm Ville Hostel', '678 Charm Street, Chennai, Tamil Nadu 600001', 'Charm Ville offers a blend of comfort and style. Ideal for female occupants looking for a secure and friendly environment.', 'female', 7500, 4.0, 3.8, 4.2),
(9, 4, 'Cultural Haven PG', '5677 Arts Avenue, Chennai, Tamil Nadu 600100', 'Embrace the cultural vibe at Cultural Haven PG. A mix of art, music, and good company. Suitable for all genders.', 'unisex', 8000, 4.2, 4.1, 4.4),
(10, 4, 'Tranquil Residency', '789 Peaceful Lane, Hyderabad, Telangana 500001', 'Experience tranquility at its best. An oasis of peace for both male and female occupants.', 'unisex', 6000, 3.8, 3.9, 4.0),
(11, 2, 'Sea Breeze Residency', '123 Coastal Road, Mumbai, Maharashtra 400094', 'Experience the cool sea breeze at this seaside residency. Ideal for those who love the ocean view. Suitable for all genders.', 'unisex', 9500, 4.5, 4.3, 4.7),
(12, 3, 'Green Meadows PG', '456 Nature Lane, Bangalore, Karnataka 560003', 'Live in the lap of nature at Green Meadows PG. Surrounded by greenery and tranquility. Suitable for both male and female occupants.', 'unisex', 8200, 4.2, 4.1, 4.5),
(13, 4, 'Techie\'s Paradise Hostel', '789 IT Street, Chennai, Tamil Nadu 600003', 'A paradise for tech enthusiasts! State-of-the-art facilities for a comfortable stay. Ideal for both male and female occupants.', 'unisex', 8800, 4.4, 4.2, 4.6),
(14, 1, 'Historical Haven PG', '987 Heritage Road, New Delhi, Delhi 110013', 'Immerse yourself in history at this PG near historical landmarks. Perfect for history buffs. Suitable for both male and female occupants.', 'unisex', 7300, 4.0, 3.9, 4.1),
(15, 2, 'City Lights Residency', '345 Downtown Street, Mumbai, Maharashtra 400095', 'Live in the heart of the city with dazzling lights. Perfect for city lovers. Suitable for all genders.', 'unisex', 9100, 4.3, 4.2, 4.8);
...
(5, 'avinash.2102590@stu.ctgroup.in', '7850cc4ab6bb9be47d029e5f71ff95a8455d4065', 'avinash', '6239378916', 'male', 'Ct institute of technology ');
